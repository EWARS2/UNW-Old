# Title: treeview_refresh.py fork
# In-class Exercise
...
def update_record():
    selected = my_status.focus()
    # save new data
    my_status.item(selected, text="", values=(studentid_entry.get(), studentfirstname_entry.get(), studentlastname_entry.get(), studentgpa_entry.get()))
    # clear entry boxes
    studentid_entry.delete(0, END)
    studentfirstname_entry.delete(0, END)
    studentlastname_entry.delete(0, END)
